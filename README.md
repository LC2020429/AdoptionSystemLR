...
1. **Actualizar Foto del Usuario**
  ...
  - **Editar foto usuario**
  -tambien elimina la foto actual por cuestion de espacio
  - **URL:** `adoptionSystem/v1/user/updateProfilePicture/ idMongodel user`
  - **Metdo** patch


2. **Listar Citas**
   - Descripción: Implementar funcionalidad para listar todas las citas.
...
3. **Actualizar Cita**
  ...
  - Edita las citas
  - **URL:** `adoptionSystem/v1/appointment/updateAppointment/ id cita`
  - **Metdo** put

4. **Cancelar Cita**
   - Descripción: Implementar funcionalidad para cancelar una cita existente.
    - **Cancelar Citas por usuario**
  - Edita las citas
  - **URL:** `adoptionSystem/v1/appointment/listAppointments`
  - **Metdo** delete
